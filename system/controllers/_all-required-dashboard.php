...
/*************************************************************************/
	...
	$D->adsDashboard1 = trim($this->network->get_ads('adsbasic1'));
	$D->adsDashboard2 = trim($this->network->get_ads('adsbasic2'));
...
/*************************************************************************/
	...
	foreach($userAleat as $oneUser) {
		...
		$D->accd_codeuser = $oneUser->code;
		$D->accd_avatar = $oneUser->avatar;
		$D->accd_numphotos = $oneUser->num_posts;
