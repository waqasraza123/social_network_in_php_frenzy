...
if ($errored == 1) {
	...
	$valcaptcha = $_SESSION['captchasum'];
	if ($captcha != $valcaptcha){
		echo("0: ".$this->lang('home_f_signup_error9')); die();
	}
