<div class="onefollower">
    ...
    <div class="info">
        ...
        <div class="moreinfo"><?php echo $D->f_numphotos==1?$this->lang('dashboard_following_hasphoto', array('#NUM#'=>$D->f_numphotos)):$this->lang('dashboard_following_hasphotos', array('#NUM#'=>$D->f_numphotos)); ?></div>
    </div>
    <div class="sh"></div>
