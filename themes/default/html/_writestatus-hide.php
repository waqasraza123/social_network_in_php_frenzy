...
<div>
	...
	<div id="_writestatus" class="hide mrg15T">
				...
				<div class="boxstatus">
					...
					<div class="additional-info"><input type="text" name="atach-value" id="atach-value" placeholder="<?php echo $this->lang('global_post_txtsharevideo')?>" /></div>
