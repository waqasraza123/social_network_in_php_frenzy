            ...
            <div id="dashboard-admin2">
                ...
                <div class="editarea">
					...
					<div class="boxdash">                	
                        ...
                        <div class="title"><?php echo $this->lang('admin_general_subtitle1');?></div>
						...
						<div class="spaceinfo">
                            ...
                            <div class="grey1"><?php echo $this->lang('admin_general_txt_title')?></div>
                ...
                <div class="editarea">
                	...
                	<div class="boxdash">
                        ...
                        <div class="title"><?php echo $this->lang('admin_general_subtitle2');?></div>
                        ...
                        <div class="spaceinfo">
                            ...
                            <div class="grey1"><?php echo $this->lang('admin_general_ntf_events')?></div>
                            <div class="mrg5T">
                ...
                <div class="editarea">
                	...
                	<div class="boxdash">
                    	...
                    	<div class="title"><?php echo $this->lang('admin_general_subtitle3');?></div>
                        ...
                        <div class="grey1"><?php echo $this->lang('admin_general_chat_nummsgchat')?></div>
                        <div class="mrg5T">
                ...
                <div class="editarea">
                	...
                	<div class="boxdash">
                    	...
                    	<div class="title"><?php echo $this->lang('admin_general_subtitle4');?></div>
                        ...
                        <div class="grey1"><?php echo $this->lang('admin_general_items_activities')?></div>
                        <div class="mrg5T">
                        ...
                        <div class="mrg10T grey1"><?php echo $this->lang('admin_general_items_comments')?></div>
                        <div class="mrg5T">
                        <select name="numcomments" id="numcomments" class="combobox">
                        
                        	<?php for($i=10; $i<=40; $i=$i+5) { ?>
                        	<option value="<?php echo $i?>" <?php echo($i==$D->NUM_COMMENTS_DASH_PAGE?'selected="selected"':'')?>><?php echo $i.' / '.$this->lang('admin_general_items_txtpage')?></option>
                            <?php } ?>
                ...
                <div class="editarea">
                	...
                	<div class="boxdash">
                    	...
                    	<div class="title"><?php echo $this->lang('admin_posts_title');?></div>
                        ...
                        <div class="grey1"><?php echo $this->lang('admin_posts_subtitle1')?></div>
                        <div class="mrg5T">
                        <select name="numphotospost" id="numphotospost" class="combobox">
                        
                        	<?php for($i=3; $i<=9; $i=$i+3) { ?>
                        	<option value="<?php echo $i?>" <?php echo($i==$D->NUM_PHOTOS_POST?'selected="selected"':'')?>><?php echo $i?></option>
                            <?php } ?>
                        ...
                        <div class="mrg10T grey1"><?php echo $this->lang('admin_posts_subtitle2')?></div>
                        <div class="mrg5T">
                        <select name="numcommentsperpost" id="numcommentsperpost" class="combobox">
                        
                        	<?php for($i=2; $i<=10; $i++) { ?>
                        	<option value="<?php echo $i?>" <?php echo($i==$D->NUM_COMMENTS_PER_POST?'selected="selected"':'')?>><?php echo $i?></option>
                            <?php } ?>
...
<script>
	...
	$('#bsave5').click(function(){
		updatePosts('#msgerror5','#msgok5','#bsave5');
		return false;
	}); 
</script>  
