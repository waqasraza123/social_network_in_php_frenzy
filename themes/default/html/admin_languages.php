            ...
            <div id="dashboard-admin2">
                ...
                <div class="editarea">
                    ...
                    <div class="boxdash">
	                    ...
	                    <div class="title"><?php echo $this->lang('admin_languages_subtitle1');?></div>
                      ...
                      <form id="formlang" name="formlang" method="post" action="">
                        <div class="grey1"><?php echo $this->lang('admin_languages_txt1')?></div>
                        <div class="mrg10T">
                        <select name="language" id="language" class="combobox">
                        <?php foreach($D->listlanguages as $k=>$v) {?>
                        	<option value="<?php echo($k)?>" <?php echo($k==$D->langDefault?'selected="selected"':'')?>><?php echo($v)?></option>
                        <?php } ?>
                        </select>
                        </div>
