            ...
            <div id="dashboard-admin2">
                ...
                <div class="editarea">
                	...
                	<div class="boxdash">
	                    ...
	                    <div class="title"><?php echo $this->lang('admin_pages_subtitle1');?></div>
                        ...
                        <div class="grey1"><?php echo $this->lang('admin_pages_textenter')?></div>
                        <div>
                ...
                <div class="editarea">
					...
					<div class="boxdash">
                    	...
                    	<div class="title"><?php echo $this->lang('admin_pages_subtitle2');?></div>
                ...
                <div class="editarea">
                	...
                	<div class="boxdash">
                        ...
                        <div class="title"><?php echo $this->lang('admin_pages_subtitle3');?></div>
                ...
                <div class="editarea">
                	...
                	<div class="boxdash">
	                    ...
	                    <div class="title"><?php echo $this->lang('admin_pages_subtitle4');?></div>
                ...
                <div class="editarea">
                	...
                	<div class="boxdash">
                    	...
                    	<div class="title"><?php echo $this->lang('admin_pages_subtitle5');?></div>
