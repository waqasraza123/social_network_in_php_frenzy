        ...
        <div id="column2">
            ...
            <div id="dashboard2">
				...
				<div class="boxdash">
                    ...
                    <div class="title"><?php echo $this->lang('dashboard_followers_title'); ?></div>
                    
                    <div class="spaceinfo">
                    
						<?php if ($D->numfollower == 0) { ?>
                        
                        <div class="mrg20T mrg30B txtsize00 centered"><?php echo $this->lang('dashboard_followers_nofollowers'); ?></div>
