        ...
        <div id="column2">
            ...
            <div id="dashboard2">
                ...
                <div class="spaceWhite" id="_bwritest">
                	...
                	<div class="title fleft"><?php echo $this->lang('dashboard_myphotos_title'); ?></div>
                ...
                <div class="boxdash" id="_bwritest">
                	...
                	<div class="title"><?php echo $this->lang('dashboard_myphotos_title'); ?></div>
                    
                    <div class="spaceinfo">
                
                		<div id="_areanoitem" class="centered txtsize01 mrg20T"><?php echo $this->lang('dashboard_myphotos_nophotos');?></div>
