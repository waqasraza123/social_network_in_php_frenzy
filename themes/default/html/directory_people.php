...
?>
<div id="generalspace" style="padding-top:20px;">
    ...
    <div id="container">
    	...
    	<div id="directory">
			...
			<div class="boxprof">
				...
				<div class="spaceinfo" style="padding:20px;">                
                    ...
                    <div class="mrg10T">
                        ...
                        <div class="fleft"><a href="javascript:searchPeople();"><img src="<?php echo $C->SITE_URL?>themes/<?php echo $C->THEME ?>/imgs/icobsearch.png"></a></div>
                        <div class="sh"></div>
                    </div>
                    ...
                    <?php if ($D->pageCurrent != 1) { ?>
                        <span><a href="<?php echo $C->SITE_URL?>directory/people/p:<?php echo($D->pageCurrent - 1)?>"><img src="<?php echo $C->SITE_URL?>themes/<?php echo $C->THEME ?>/imgs/arrow-left.png"></a></span>
                    <?php } ?>
                    ...
                    <?php if ($D->pageCurrent != $D->lastPage) { ?>
                        <span><a href="<?php echo $C->SITE_URL?>directory/people/p:<?php echo($D->pageCurrent + 1)?>"><img src="<?php echo $C->SITE_URL?>themes/<?php echo $C->THEME ?>/imgs/arrow-right.png"></a></span>
                    <?php } ?>
