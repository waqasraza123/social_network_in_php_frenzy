                ...
                ?>            
                    ...
                    <div id="profile2">
						...
						<div class="boxprof">
                            ...
                            <div class="title"><?php echo $this->lang('profile_followers_title'); ?></div>
                            
                           	<div class="spaceinfo">
                            
								<?php if ($D->numfollower == 0) { ?>
                                
                                <div class="centered mrg20T mrg30B txtsize00"><?php echo $this->lang('profile_followers_nofollowers'); ?></div>
