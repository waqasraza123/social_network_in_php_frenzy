			...
			<div>
                ...
                ?>            
                    ...
                    <div id="profile2">
                        ...
                        <div class="title spaceWhite"><?php echo $this->lang('profile_like_title'); ?></div>
                        
                        <div><?php echo $D->htmlResult; ?></div>
                        
                        
                        <?php if ($D->totalposts > $C->NUM_FAVORITES_PAGE) { ?>
                        ...
                        <div class="boxprof">
                            ...
                            <div class="spaceinfo">
                        		...
                        		<div id="_areanoitem" class="centered txtsize00 mrg30B mrg20T"><?php echo $this->lang('profile_like_nolikes');?></div>
