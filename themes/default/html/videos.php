			...
			<div>
                ...
                ?>            
                    ...
                    <div id="profile2"> 
                        ...
                        <div class="title spaceWhite"><?php echo $this->lang('profile_videos_title'); ?></div>
                        ...
                        <div class="boxprof">
                        	...
                        	<div class="title"><?php echo $this->lang('profile_videos_title'); ?></div>
                            
                            <div class="spaceinfo">
                        
                        		<div id="_areanoitem" class="centered txtsize00 mrg20T mrg30B"><?php echo $this->lang('profile_videos_txtnovideos');?></div>
